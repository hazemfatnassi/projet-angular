...
export class Game2Component {
  ...
  fois = 0;
  correctAnswers = [
    'India', 'Spain', 'Tunisia', 'France', 'China', 'Egypt', 'Japan', 'Algeria', 'Turkey', 'Mexico', 'Russia', 'Italy', 'England', 'USA', 'vietname'
  ];
  ...
  questionsList = [
    ...
    { title: 'Stonehenge', image: 'q13.jpg', options: ['Portugal', 'Spain', 'England', 'Angletere'] },
    { title: 'Golden Gate Bridge', image: 'q14.jpg', options: ['Canada', 'USA', 'Germany', 'Brazil'] },
    { title: 'La Grande Muraille', image: 'q15.jpg', options: ['vietname', 'Japan', 'India', 'Pakistan'] }
